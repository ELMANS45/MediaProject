...
export default function Profile() {
  const {photo , getAllPosts, profilePosts} = useContext(ProfileContext)
  ...
  return (
    <>  
          {isLoading ? <Loading/> : <div className="container flex justify-center items-center my-auto mt-20" key={id}>
            <div className="flex flex-col justify-center max-w-xs p-6 shadow-md rounded-xl sm:px-12 dark:bg-gray-50 dark:text-gray-800">
	<img src={photo} alt="" className="w-32 h-32 mx-auto rounded-full dark:bg-gray-500 aspect-square" />
